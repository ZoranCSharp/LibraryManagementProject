...
namespace LibraryManagement2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FullName,Email,RoleID,LibraryID,Password")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FullName,Email,RoleID,LibraryID,Password")] Employee employee)
        {
            if (ModelState.IsValid)
            {
