...
namespace LibraryManagement.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FullName,Email,RoleID,LibraryID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FullName,Email,RoleID,LibraryID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
